---
title: What is TAC
description: 'Learn more about TON App Chain - how it works and why it exists'
---


TON App Chain (TAC) is a compatibility layer connecting TON with the Ethereum Virtual Machine (EVM). It enables users to access EVM applications directly through their TON wallets, eliminating the need for managing multiple wallets or using traditional bridges.
